...
*/
let goal = 12
let milesBiked: [Int] = [1,3,6,2,4,67,43,2,5,7,12,3,5,6,8,3,2,67,5,23,76,3,56,90,12]
milesBiked.count
...
func checkProgress(item: Int) -> String {
    if item > goal + 20 {
        return "Keep going!"
    } else if item > goal {
        return "You can do better!"
    } else {
        return "what the dillyo?"
    }
}
